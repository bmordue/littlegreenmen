...
describe GamesController do
  ...
  describe "POST create" do
    ...
    # Disable generated tests that are failing
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested game" do
        ...
        Game.any_instance.should_receive(:update).with({ "terrain" => "..L." })
        put :update, {:id => game.to_param, :game => { "terrain" => "..L." }}, valid_session
      end
